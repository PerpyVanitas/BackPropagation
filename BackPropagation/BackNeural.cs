...
namespace Backprop
{
	public class NeuralNet
	{
        ...
        public double getOuputData(int pos) => oneuron[pos].getOActivation();
        public void setInputs(int pos, double data) => ineuron[pos].setInput(data);
        public void setDesiredOutput(int pos, double data) => desiredout[pos] = data;
