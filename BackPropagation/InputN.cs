...
namespace Backprop
{
	public class INeuron
	{
        ...
        public void setID(int no) => idno = no;
        public void setInput(double data) => input = data;
        public double getInput() => input;
        public double getWeight(int hidno) => weights[hidno];
        public int getID() => idno;
